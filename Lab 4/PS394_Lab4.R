...
summary(data) # but it's not - still reading as character variables because R decides that when you download the data, that makes sense. So you need to import it

# so let's quickly jump out of R, open the data file in Excel, delete the two extra rows (row 2 and 3 in excel - keep the variable names). Save the data with your initials at the end (i.e., "_XX")
